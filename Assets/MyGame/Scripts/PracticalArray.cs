...
public class PracticalArray : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        arrayColoredImagesRed
        = GameObject.FindGameObjectsWithTag("RedImage");

        Debug.Log("Element 0 von array 1 hat den Wert: " + array1[0]);
        Debug.Log("Element 0 von array 1 hat den Wert: " + array2[0]);
        Debug.Log("Element 0 von array 1 hat den Wert: " + array3[0]);
        Debug.Log("Element 0 von array 1 hat den Wert: " + array4[0]);
        ...
        Debug.Log("Element 0 von array 1 hat den Wert: " + array2[array2.Length - 1]);
        Debug.Log("Element 0 von array 1 hat den Wert: " + array3[array3.Length - 1]);
        Debug.Log("Element 0 von array 1 hat den Wert: " + array4[array4.Length - 1]);
